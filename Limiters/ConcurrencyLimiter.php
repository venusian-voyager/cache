...
class ConcurrencyLimiter
{
     ...
     *
     * @var \Voyager\Contracts\Cache\LockProvider
     */
    protected $store;
     ...
     *
     * @param  \Voyager\Contracts\Cache\LockProvider  $store
     * @param  string  $name
     * @param  int  $maxLocks
     ...
     * @return mixed
     *
     * @throws \Voyager\Cache\Limiters\LimiterTimeoutException
     * @throws \Throwable
     */
     ...
     *
     * @param  string  $id
     * @return \Voyager\Contracts\Cache\Lock|false
     */
     ...
     * Release the lock.
     *
     * @param  \Voyager\Contracts\Cache\Lock  $lock
     * @return void
     */
